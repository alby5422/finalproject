...
function EventDetails() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-blue-100">
            <Navbar />
            <div className="flex-grow flex items-center justify-center py-10"> {/* Center content */}
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-4xl">
                    <h1 className="text-3xl font-bold mb-4 text-black">{event.name}</h1>
                    <p className="mb-4 text-gray-700">{event.description}</p>
                    <h2 className="text-2xl font-bold mb-2 text-black">Categories</h2>
                    ...
                    <h2 className="text-2xl font-bold mb-2 text-black">Cost</h2>
                    <p className="text-gray-700">{event.cost}</p>
                    <h2 className="text-2xl font-bold mb-2 text-black">Images</h2>
                    ...
                    <div className="mt-6">
                        <button className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700" onClick={openModal}>Book Now</button>
                    </div>
                </div>
            </div>
            <Modal
            ...
            >
                ...
                <form onSubmit={handlePaymentSubmit}>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">Name on Card</label>
                        <input
                            id="name"
                            name="name"
                            type="text"
                    ...
                    <div className="flex mb-4">
                        <div className="w-1/2 mr-2">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="expiry">Expiry Date</label>
                            <input
                                id="expiry"
                                name="expiry"
                                type="text"
